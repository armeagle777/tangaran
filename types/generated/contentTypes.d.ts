...
export interface ApiCommunityCommunity extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    nameEng: Attribute.String & Attribute.Required;
    ...
    items: Attribute.Relation<
      ...
      'api::item.item'
    >;
    communityId: Attribute.Integer & Attribute.Required & Attribute.Unique;
    regionId: Attribute.Integer;
...
export interface ApiMeaningMeaning extends Schema.CollectionType {
  collectionName: 'meanings';
  info: {
    singularName: 'meaning';
    pluralName: 'meanings';
    displayName: 'meaning';
  };
  options: {
...
export interface ApiRegionRegion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.Relation<
      ...
      'api::item.item'
    >;
    regionId: Attribute.Integer & Attribute.Required & Attribute.Unique;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::meaning.meaning': ApiMeaningMeaning;
